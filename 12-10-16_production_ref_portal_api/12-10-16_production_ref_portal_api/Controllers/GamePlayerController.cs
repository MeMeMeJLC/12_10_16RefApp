...
namespace _12_10_16_production_ref_portal_api.Controllers
{
    public class GamePlayerController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,PlayerId,GameId,IsCaptain")] GamePlayer gamePlayer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,PlayerId,GameId,IsCaptain")] GamePlayer gamePlayer)
        {
            if (ModelState.IsValid)
            {
